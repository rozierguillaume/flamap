...
- [ ] Sous-lot `10B-psfdf` : extraire le suivi et les graphiques PSFDF.
- [ ] Sous-lot `10C-aircraft` : extraire les avions, leur historique et leur
      polling.
