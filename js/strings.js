...
export const STRINGS = {
  ...
  'notifications.add': { fr: 'Ajouter', es: 'Añadir' },
  'notifications.addIntro': { fr: 'Comment souhaitez-vous définir cette adresse ?', es: '¿Cómo quieres definir esta dirección?' },
  'notifications.addByAddress': { fr: 'Saisir une adresse', es: 'Introducir una dirección' },
  'notifications.addByAddressHint': { fr: 'Recherchez une commune ou un code postal.', es: 'Busca un municipio o un código postal.' },
  'notifications.addByMap': { fr: 'Choisir sur la carte', es: 'Elegir en el mapa' },
  'notifications.addByMapHint': { fr: 'Cliquez à l’endroit à surveiller.', es: 'Haz clic en el lugar que quieres vigilar.' },
  ...
  'notifications.mapIntro': { fr: 'Cliquez sur la carte pour placer le centre du périmètre.', es: 'Haz clic en el mapa para colocar el centro del perímetro.' },
  'notifications.mapLocation': { fr: 'Point choisi — {lat}, {lon}', es: 'Punto elegido — {lat}, {lon}' },
